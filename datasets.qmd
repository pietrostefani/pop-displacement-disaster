...
-   Climate data:
    ...
    -   Dekadal (10-day) rainfall data from 20201 at the district level (coded to OCHA administrative level 2) sourced from the World Food Programme (WFP). Data shows series of metrics for rainfall, listed [here](https://data.humdata.org/dataset/pak-rainfall-subnational).

    -   Dekadal (10-day) Normalized Difference Vegetation Index (NDVI) data from 2021 at the district level (coded to OCHA administrative level 2) sourced from the World Food Programme (WFP). Data shows series of metrics for vegetian greenness, listed [here](https://data.humdata.org/dataset/pak-rainfall-subnational), normally used to quantify the health and density of vegetation.
...
+-----------------------------------------------------------------------+--------------------------------------------+-------------------------+-------------------------------------------------------------+
| Aggregated Population Data (ocha_2 and ocha_3)                        | ADM1_PCODE                                 | Division (adm1) polygon | OCHA subnational polygons (**ADM1_PCODE**)(**ADM2_PCODE**)  |
|                                                                       |                                            |                         |                                                             |
...
+-----------------------------------------------------------------------+--------------------------------------------+-------------------------+-------------------------------------------------------------+
| Aggregated Global Relative Deprivation Index Data (ocha_2 and ocha_3) | ADM1_PCODE                                 | Division (adm1) polygon | OCHA subnational polygons (**ADM1_PCODE**)(**ADM2_PCODE**)  |
|                                                                       |                                            |                         |                                                             |
|                                                                       | ADM2_PCODE                                 | District (adm2) polygon |                                                             |
+-----------------------------------------------------------------------+--------------------------------------------+-------------------------+-------------------------------------------------------------+
