...
-   Climate data:
    ...
    -   Dekadal (10-day) rainfall data from 2021 at the district level (coded to OCHA administrative level 2) sourced from the World Food Programme (WFP). Data shows series of metrics for rainfall, listed [here](https://data.humdata.org/dataset/pak-rainfall-subnational).
